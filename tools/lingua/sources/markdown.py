...
filename stem), the description from frontmatter or the first paragraph.
    ...
    for group in groups:
        ...
        for position, doc_path in enumerate(docs, 1):
            ...
            chapters.append(Chapter(
                ...
                source_url=f"{repo}/blob/main/{rel}" if repo else None,
                content_hash=hashlib.sha256(doc_hash.encode()).hexdigest()[:12],
            ))
